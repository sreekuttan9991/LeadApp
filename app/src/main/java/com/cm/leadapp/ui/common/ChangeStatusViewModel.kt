...
@HiltViewModel
class ChangeStatusViewModel @Inject constructor(val repository: ChangeStatusRepository, val pref: MySharedPref) : ViewModel() {
    ...
    fun changeStatus(leadId: String,statusId: String,finalStatus: String,invoiceNo: String,

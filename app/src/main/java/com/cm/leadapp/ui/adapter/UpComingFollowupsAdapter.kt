...
class UpComingFollowupsAdapter(private val followupsItemClickListener: OnFollowupsItemClickListener) :
    PagingDataAdapter<FollowupData, UpComingFollowupsAdapter.FollowupViewHolder>(COMPARATOR) {
    ...
    class FollowupViewHolder(
        ...
        private val txtType = binding.tvProduct
        ...
        fun bind(item: FollowupData?) {
            item?.let {
                ...
                txtType.text = it.followupType?.firstCapital()
